...
public:
    ...
    static uint64 r_a1(){
        uint64 volatile a;
        asm volatile("mv %0, a1" : "=r" (a));
        return a;
    }
    static uint64 r_a2(){
        uint64 volatile a;
        asm volatile("mv %0, a2" : "=r" (a));
        return a;
    }
    static uint64 r_a3(){
        uint64 volatile a;
        asm volatile("mv %0, a3" : "=r" (a));
        return a;
    }
    static uint64 r_a4(){
        uint64 volatile a;
        asm volatile("mv %0, a4" : "=r" (a));
        return a;
    }
    static uint64 r_a5(){
        uint64 volatile a;
        asm volatile("mv %0, a5" : "=r" (a));
        return a;
    }
    static uint64 r_a6(){
        uint64 volatile a;
        asm volatile("mv %0, a6" : "=r" (a));
        return a;
    }
    static uint64 r_a7(){
        uint64 volatile a;
        asm volatile("mv %0, a7" : "=r" (a));
        return a;
    }
    static void HALT(){     //shuts down qemu emulator
